...
export const topSupporter: LeaderboardBoard = {
  ...
  unit: "yen",
  champion: { username: "Kyle1517", value: 122432 },
  entries: [
    { rank: 2, username: "Kyrozepyro", value: 104205 },
    { rank: 3, username: "Tea_cchi", value: 80302 },
    { rank: 4, username: "shvnek", value: 71982 },
    { rank: 5, username: "jriddlec", value: 62652 },
    { rank: 6, username: "DrowsyRBX", value: 58327 },
    { rank: 7, username: "shugoy", value: 58136 },
    { rank: 8, username: "LiamGame09", value: 56560 },
    { rank: 9, username: "iZeSW", value: 56000 },
    { rank: 10, username: "injvrd", value: 55440 },
  ],
}
...
export const highestLevel: LeaderboardBoard = {
  ...
  entries: [
    ...
    { rank: 3, username: "CosMos_RE", value: 94 },
    { rank: 4, username: "theoctb09br", value: 94 },
    { rank: 5, username: "ChaoticChromatic", value: 91 },
    { rank: 6, username: "dumby121213", value: 91 },
    { rank: 7, username: "spycarrymepls", value: 87 },
    { rank: 8, username: "bw5555yz", value: 86 },
    { rank: 9, username: "Astrigion", value: 85 },
    { rank: 10, username: "un1inkk", value: 85 },
    { rank: 11, username: "flrellll1", value: 84 },
  ],
}
...
export const highestWinstreak: LeaderboardBoard = {
  ...
  unit: "winstreak",
  champion: { username: "KaVoyJin", value: 250 },
  entries: [
...
export const achievements = [
  { code: "ACH-001", name: "FIRST BLOOD", desc: "Register your first elimination", unlocked: "92%" },
  { code: "ACH-014", name: "RED LINE CROSSED", desc: "Win 10 matches in a row", unlocked: "18%" },
  { code: "ACH-027", name: "CONTRACT KILLER", desc: "Accumulate ¥1,000,000 contract value", unlocked: "11%" },
  { code: "ACH-042", name: "PROFESSIONAL", desc: "Reach Level 42", unlocked: "6%" },
  { code: "ACH-099", name: "GHOST PROTOCOL", desc: "Win a duel without taking damage", unlocked: "3%" },
  { code: "ACH-100", name: "LEGEND OF REDLINER", desc: "Reach the top of any leaderboard", unlocked: "0.4%" },
]

export const tournamentWinners = [
  { season: "S04", event: "REDLINE CUP", winner: "KaVoyJin", prize: "¥5,000,000" },
  { season: "S03", event: "WINGMAN INVITATIONAL", winner: "Expert_Zerby & CosMos_RE", prize: "¥3,200,000" },
  { season: "S02", event: "BATTLEGROUNDS ROYALE", winner: "deprivationist", prize: "¥2,800,000" },
  { season: "S01", event: "FOUNDERS DUEL", winner: "Kyle1517", prize: "¥1,500,000" },
]
