...
import { ChevronRight, Users, Gamepad2, ExternalLink } from "lucide-react"
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
      <SectionHeading
        code="03"
        title="COMMUNITY"
        subtitle="Featured operators and active deployment modes. Expand any module to access its records."
      />
